...
{
    public static Dictionary<TechResearchTypes, (int cost, TimeSpan researchTime, List<TechResearchTypes> preReqs, string name, string description)> Values { get; } = new()
    {
        // Miltaire
        { TechResearchTypes.Armement_I, 
            (cost: 0, researchTime: TimeSpan.FromDays(1), 
