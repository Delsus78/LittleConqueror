...
namespace LittleConqueror.Infrastructure.Migrations
{
    ...
    [Migration("20240917142915_AddingTechConfigs")]
    partial class AddingTechConfigs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LittleConqueror.AppService.Domain.Models.Entities.AuthUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1L,
                            Hash = "$2a$13$aOvaechO0xmTmzNXUbTTMexs76ed3Rtxn3mYpntslYH37gj0Nr7AW",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("LittleConqueror.AppService.Domain.Models.Entities.Configs", b =>
                {
                    ...
                    b.Property<TechConfig[]>("TechResearchConfigs")
                        .IsRequired()
                        .HasColumnType("jsonb");
