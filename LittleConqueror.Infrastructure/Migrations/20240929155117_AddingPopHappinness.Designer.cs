...
namespace LittleConqueror.Infrastructure.Migrations
{
    ...
    [Migration("20240929155117_AddingPopHappinness")]
    partial class AddingPopHappinness
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LittleConqueror.AppService.Domain.Models.Entities.AuthUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1L,
                            Hash = "$2a$13$kkrnfBCW1uiRtJG7XTK.GeMGP7sbREzkkVtGhnM0NpUrIV1/fsezK",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("LittleConqueror.AppService.Domain.Models.Entities.Configs", b =>
                {
                    b.OwnsMany("LittleConqueror.AppService.Domain.Models.Configs.PopHappinessConfig", "PopHappinessConfigs", b1 =>
                        {
                            ...
                            b1.ToJson("PopHappinessConfigs");

                            b1.WithOwner()
                                .HasForeignKey("ConfigsId");
                        });

                    b.OwnsMany("LittleConqueror.AppService.Domain.Models.Configs.TechConfig", "TechResearchConfigs", b1 =>
                        {
                            b1.Property<long>("ConfigsId")
                                .HasColumnType("bigint");
                    ...
                    b.Navigation("PopHappinessConfigs");
